...
public class GUI {
	...
	public void removeContent() {
		...
		if( content != null ) {
			...
			if( content instanceof Deconstructable ) ((Deconstructable) content).deconstruct(); 
		}
		content = null; 
		toolBar = null; 
	...
	public void setToolBar( Component c ) {
		...
		if( toolBar != null ) mainPane.remove(toolBar ); 
	...
	public void saveContent() {
		...
		if( content instanceof Savable ) ((Savable) content).saveStateToModel(); 
	}
