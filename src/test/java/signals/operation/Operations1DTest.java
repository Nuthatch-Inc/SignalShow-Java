...
/**
 * Comprehensive test suite for 1D convolution, correlation, and
 * autocorrelation.
 * 
 * These tests verify that the FFT-based implementations match the mathematical
 * definitions from Roger Easton's book "Fourier Methods in Imaging" (Chapter
 * 8).
 * 
 ...
 * Property: Result is Hermitian (even real part, odd imaginary part for real
 * input)
