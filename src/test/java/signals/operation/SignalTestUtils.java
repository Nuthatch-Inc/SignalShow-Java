 ...
 * Provides helper methods for creating test signals, comparing arrays, and computing
...
public class SignalTestUtils {
    ...
    /**
     * Complex multiplication with conjugate of second operand: (a + bi)(c - di) = (ac + bd) + (bc - ad)i
     */
    ...
    public static void printSignal(String name, double[] signal) {
        ...
        for (int i = 0; i < signal.length; i++) {
            ...
            if (i < signal.length - 1) System.out.print(", ");
        }
        System.out.println("]");
    }
}
