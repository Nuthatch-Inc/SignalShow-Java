...
public class Core {
	...
	/**
	 * SingletonCoreHolder is loaded on the first execution of Singleton.getInstance() 
	...
	public static void addToMainList( Object item ) {
		...
		if( item instanceof Function1D ) incrementNum1DFunctions(); 
		else if( item instanceof Function2D ) incrementNum2DFunctions(); 
	}
	...
	public static void incrementNum1DFunctions() {
		...
		}	if( num2DFunctions == 0 ) Core.getGUI().setHasFunctions(true);
	}
	...
	public static void decrementNum1DFunctions() {
		...
		if( num1DFunctions == 0 ) {
			...
			if( num2DFunctions == 0 ) Core.getGUI().setHasFunctions(false);
		}
	}
	...
	public static void incrementNum2DFunctions() {
		...
		if( num2DFunctions == 1 ) {
			...
			if( num1DFunctions == 0 ) Core.getGUI().setHasFunctions(true);
		}
	}
	...
	public static void decrementNum2DFunctions() {
		...
		if( num2DFunctions == 0 ) {
			...
			if( num1DFunctions == 0 ) Core.getGUI().setHasFunctions(false);
		}
	}
