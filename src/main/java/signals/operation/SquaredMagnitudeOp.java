...
public class SquaredMagnitudeOp extends UnaryOperation {

	public SquaredMagnitudeOp() {
		super();
		// TODO Auto-generated constructor stub
	}


	public SquaredMagnitudeOp(ParameterBlock paramBlock, int priority) {
		super(paramBlock, priority);
		// TODO Auto-generated constructor stub
	}


	public SquaredMagnitudeOp(ParameterBlock paramBlock) {
	...
	public Function create( Function input ) {
		...
		double[] realOut = ArrayMath.squaredMagnitude(real, imag);
...
//		model.setSmallIcon("/operationIcons/SquaredMagnitudeSmall.png");
		model.setName("Squared Magnitude");
		
		model.setDocPath("/operationdoc/squaredmagnitude.html");
	}

	@Override
	public String getOpIconPath() {

		return "/operationIcons/SquaredMagnitudeOp.png"; 
	}
