...
public class Histogram {
	...
	/**
	 * Bin Tag
	 * This signals.operation takes data and places it into one of numBins "bins",
	 * where the bins range between
	 * minBinVal and maxBinVal. What is returned is an integer array the size of the
	 * original data
	 * where the value at index i is the bin number that corresponds to the original
	 * data at index i.
	 * 
	 * @param input     - data to take the histogram of
	 * @param numBings  - the number of bins to use in the histogram
	 * @param minBinVal - the value of the first bin. A typical value is the minimum
	 *                  data value or 0.
	 * @param maxBinVal - the value to use for the last bin. A typical value is the
	 *                  maximum data value or 255.
	 ...
	 * @param minBinVal - the minimum value of the first bin. A typical value is the
	 *                  minimum data value or 0.
	 * @param maxBinVal - the maximum value to use for the last bin. A typical value
	 *                  is the maximum data value or 255.
	 *                  precondition - maxBinVal > minBinVal
	 */
	...
	/**
	 * Calculate PDF
	 * Calculates the histogram, then divides each element by the total number of
	 * pixels
	 * 
	 * @param input     - data to take the histogram of
	 * @param numBings  - the number of bins to use in the histogram
	...
	public static double[] equalizeHistogram(double[] input, int numBins, double minBinVal, double maxBinVal) {
		...
		// next, create the lookup table by finding the cdf, then for each cdf entry,
		// multiplying by range and adding in the minimum.
