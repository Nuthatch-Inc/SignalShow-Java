 ...
 * 
 */
public class AbsMonomialFunctionTerm1D extends AnalyticFunctionTerm1D { 
	
	public AbsMonomialFunctionTerm1D() {
		super();
	 ...
	 * @param paramBlock
	 */
	public AbsMonomialFunctionTerm1D(ParameterBlock paramBlock) {
	...
	public double[] create(double[] indices) {
		...
		for ( int i = 0; i < dimension; ++i )  {
				...
				monomial[i] = amplitude * Math.abs(Math.pow(arg, exponent));
		}
...
//		model.setLargeIcon("/functionIcons/AbsMonomial1DLarge.png");
//		model.setSmallIcon("/functionIcons/AbsMonomial1DSmall.png");
		model.setName("Abs Val Monomial");
		...
		model.setDocPath("/functiondoc/absmonomial.html");
	}
